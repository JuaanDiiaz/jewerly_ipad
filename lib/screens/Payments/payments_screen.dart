...
class _PaymentsScreenState extends State<PaymentsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // Ensure "Multiple Payments" method exists for handling multi-payment sales
      if (mounted) {
            ...
            children: [
              ...
              Consumer<PaymentMethodProvider>(
                builder: (context, pmProvider, _) {
                  return DropdownButtonFormField<int>(
                    ...
                    items: pmProvider.paymentMethods.map((m) {
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (amount > remaining) return 'Amount exceeds remaining balance';
                  return null;
                },
              ),
              const SizedBox(height: 12),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final success = await context.read<CustomerPaymentProvider>().createPayment(payment);
              if (context.mounted) {
              ...
              builder: (context, salesProvider, customerProvider, paymentProvider, pmProvider, _) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final statusColor = _getStatusColor(paid, total);
                    final statusText = _getStatusText(paid, total);
  ...
  Widget _buildPaymentCard(CustomerPaymentModel payment) {
